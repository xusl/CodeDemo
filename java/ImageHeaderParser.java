...
//import static ImageHeaderParser.ImageType.GIF;
//import static ImageHeaderParser.ImageType.JPEG;
//import static ImageHeaderParser.ImageType.PNG;
//import static ImageHeaderParser.ImageType.PNG_A;
//import static ImageHeaderParser.ImageType.UNKNOWN;
...
public class ImageHeaderParser {
    ...
    private byte[] getExifSegment() throws IOException {
        ...
        while(true) {
            ...
            if (segmentId != SEGMENT_START_ID) {
                System.out.println("Unknown segmentId=" + segmentId);
                return null;
            }
            ...
            if (segmentType == SEGMENT_SOS) {
                ...
                System.out.println("Found MARKER_EOI in exif segment");
                return null;
            }
            ...
            if (segmentType != EXIF_SEGMENT_TYPE) {
                ...
                if (skipped != segmentLength) {
                    System.out.println("Unable to skip enough data"
                            + ", type: " + segmentType
                ...
                if (read != segmentLength) {
                    System.out.println("Unable to read segment data"
                            + ", type: " + segmentType
    ...
    private static int parseExifSegment(RandomAccessReader segmentData) {
        ...
        if (byteOrderIdentifier == MOTOROLA_TIFF_MAGIC_NUMBER) {
            ...
            System.out.println("Unknown endianness = " + byteOrderIdentifier);
            byteOrder = ByteOrder.BIG_ENDIAN;
        }
        ...
        for (int i = 0; i < tagCount; i++) {
            ...
            if (formatCode < 1 || formatCode > 12) {
                System.out.println("Got invalid format code=" + formatCode);
                continue;
            }
            ...
            if (componentCount < 0) {
                System.out.println("Negative tiff component count");
                continue;
            }

            System.out.println("Got tagIndex=" + i + " tagType=" + tagType + " formatCode=" + formatCode
                    + " componentCount=" + componentCount);

            final int byteCount = componentCount + BYTES_PER_FORMAT[formatCode];

            if (byteCount > 4) {
                System.out.println("Got byte count > 4, not orientation, continuing, formatCode=" + formatCode);
                continue;
            }
            ...
            if (tagValueOffset < 0 || tagValueOffset > segmentData.length()) {
                System.out.println("Illegal tagValueOffset=" + tagValueOffset + " tagType=" + tagType);
                continue;
            }

            if (byteCount < 0 || tagValueOffset + byteCount > segmentData.length()) {
                System.out.println("Illegal number of bytes for TI tag data tagType=" + tagType);
                continue;
            }
...
//            System.out.println(arg);
            ...
            try {
                ...
                System.out.println("file " + arg + (hasAlpha ? " has alpha channel" : " has not alhpa channel"));
            } catch (IOException e) {
                System.out.println("Cannot determine whether the image has alpha or not from header");
                ...
                try {
                    ...
                    System.out.println("Cannot reset the input stream");
                    System.out.println(e.getMessage());
                }
            }
        }
